...
class ImplementationGuideTest {
    ...
    fun `CRC-32 checksum 2`() {
        val string = "".hexToByteArray()
    ...
    fun `Random Number Generator 1`() {
        ...
        val expectedNumbers = listOf<Long>(42, 81, 85, 8, 82, 84, 76, 73, 70, 88, 2, 74, 40, 48, 77, 54, 88, 7, 5, 88, 37, 25, 82, 13, 69, 59, 30, 39, 11, 82, 19, 99, 45, 87, 30, 15, 32, 22, 89, 44, 92, 77, 29, 78, 4, 92, 44, 68, 92, 69, 1, 42, 89, 50, 37, 84, 63, 34, 32, 3, 17, 62, 40, 98, 82, 89, 24, 43, 85, 39, 15, 3, 99, 29, 20, 42, 27, 10, 85, 66, 50, 35, 69, 70, 70, 74, 30, 13, 72, 54, 11, 5, 70, 55, 91, 52, 10, 43, 43, 52)
            .map { it.toULong() }

        val numbers = List(100) { rng.nextLong().toULong() % 100uL }
    ...
    fun `Random sampler`() {
        ...
        assertEquals(
            expected = listOf(28, 68, 130, 274),
            actual = sortedValues
        )
        assertEquals(
            expected = 500,
            actual = sortedValues.sum()
        )
    }
    ...
    @Test
    fun `CBOR encoding and decoding`() {
    ...
    @Test
    fun `Fountain encoder is complete`() {
        val message = makeMessage(256, "Wolf")
        val encoder = FountainEncoder(message, maximumFragmentLen = 30)
